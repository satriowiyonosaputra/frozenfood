        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-blue-100 dark:border-gray-700">
          <div class="p-4 sm:p-7">
            <div class="text-center">
              <h1 class="block text-2xl font-bold text-gray-800 dark:text-black">Sign up</h1>
            ...
            <form wire:submit.prevent='save'>
              <div class="grid gap-y-4">
                ...
                <div>
                  <label for="name" class="block text-sm mb-2 dark:text-black">Name</label>
                  <div class="relative">
                    <input type="text" id="name" wire:model ="name" class="py-3 px-4 block w-full border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-blue-50 dark:border-gray-700 dark:text-black dark:focus:ring-gray-600" required aria-describedby="email-error">
                    @error('name')
